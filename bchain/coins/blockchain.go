...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/trezor/blockbook/bchain/coins/fch"
	"io/ioutil"
	"math/big"
	"reflect"
	"time"
	...
	"github.com/trezor/blockbook/bchain/coins/gkc"
...
func init() {
	...
	BlockChainFactories["Freecash"] = fch.NewBitcoinRPC
	...
	BlockChainFactories["HECO"] = eth.NewEthereumRPC
	BlockChainFactories["Matic"] = eth.NewEthereumRPC
	BlockChainFactories["HECO Testnet"] = eth.NewEthereumRPC
	BlockChainFactories["OKChain"] = eth.NewEthereumRPC
	BlockChainFactories["OKChain Testnet"] = eth.NewEthereumRPC
	...
	BlockChainFactories["GKC"] = gkc.NewGKCRPC
...
func (c *blockChainWithMetrics) EthereumTypeGetErc20ContractBalanceBatch(addrDesc bchain.AddressDescriptor, contractDescs []bchain.AddressDescriptor) (v []*big.Int, err error) {
	defer func(s time.Time) { c.observeRPCLatency("EthereumTypeGetErc20ContractBalanceBatch", s, err) }(time.Now())
	return c.b.EthereumTypeGetErc20ContractBalanceBatch(addrDesc, contractDescs)
}
